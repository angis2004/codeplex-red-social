 ...
 *
 * @param {number} porcentajeSkill
 * @returns {{ icono: string, color: string, nombre: string }}
 */
export function resolverNivelRango(porcentajeSkill) {
