          ...
          <div className="flex items-center gap-3.5">
            <div className="flex items-center gap-1.5">
              {SLIDES.map((_, i) => (
                <div
                  key={i}
                  className={`h-[3px] rounded-full cursor-pointer transition-all duration-[400ms] [transition-timing-function:cubic-bezier(0.4,0,0.2,1)] ${i === current ? "w-6 bg-[var(--surface-color)]" : "w-2 bg-white/25"}`}
                  onClick={() => goTo(i)}
                />
              ))}
            </div>
...
function Login({ onLogin, onBackToDemo }) {
  ...
  return (
    ...
    >
      <div
        className="relative z-[1] grid grid-cols-[420px_1fr] max-[860px]:grid-cols-1 w-[1000px] max-w-full h-[620px] max-[860px]:h-auto bg-[var(--surface-color)] rounded-[20px] overflow-hidden border border-[var(--border-color)] [animation:cardIn_0.8s_cubic-bezier(0.16,1,0.3,1)_both]"
        style={{ boxShadow: "0 4px 6px rgba(15,30,60,0.04), 0 20px 60px rgba(15,30,60,0.10), 0 0 0 1px rgba(255,255,255,0.8)" }}
      >

        {/* ── PANEL IZQUIERDO ── */}
        <div className="login-left-panel px-[38px] py-[40px] max-[860px]:px-[28px] max-[860px]:py-[32px] max-[520px]:px-5 max-[520px]:py-6 flex flex-col bg-[var(--surface-color)] border-r border-[var(--border-color)] overflow-y-auto [animation:slideL_0.8s_0.08s_cubic-bezier(0.16,1,0.3,1)_both]">
          ...
          <div className="flex items-center gap-2.5 mb-8 [animation:fadeUp_0.6s_0.2s_both]">
            ...
            <span className="text-[17px] font-medium text-[var(--text-dark)] tracking-[-0.3px]">
              Code<strong className="font-extrabold text-[var(--primary-color)]">plex</strong>
            </span>
          </div>

          {/* Heading */}
          <h1 className="text-[22px] font-extrabold text-[var(--text-dark)] m-0 mb-1 tracking-[-0.5px] [animation:fadeUp_0.6s_0.28s_both]">
            Iniciar sesión
          </h1>
          <p className="text-[13px] text-[var(--text-muted)] font-medium m-0 mb-[22px] [animation:fadeUp_0.6s_0.32s_both]">
            Accede a tu cuenta para continuar
          </p>

          {/* Google */}
          <button
            className="flex items-center justify-center gap-[9px] w-full py-[10px] px-4 border-[1.5px] border-[var(--border-color)] rounded-[9px] bg-[var(--surface-color)] text-[var(--text-dark)] font-[Manrope,sans-serif] text-[13px] font-semibold cursor-pointer mb-2 transition-all outline-none [animation:fadeUp_0.5s_0.36s_both] hover:bg-[var(--input-bg)] hover:border-[var(--primary-color)] hover:shadow-[0_2px_12px_rgba(127,13,242,0.15)] hover:-translate-y-px"
            type="button"
          >
          ...
          <div className="grid grid-cols-3 max-[520px]:grid-cols-1 gap-[7px] mb-2 [animation:fadeUp_0.5s_0.42s_both]">
            {[
              ...
              <a
                key={label}
                className="flex items-center justify-center gap-1.5 py-[9px] px-1.5 border-[1.5px] border-[var(--border-color)] rounded-[9px] bg-[var(--surface-color)] font-[Manrope,sans-serif] text-xs font-semibold cursor-pointer text-[var(--text-dark)] no-underline whitespace-nowrap transition-all outline-none hover:-translate-y-px hover:shadow-[0_2px_10px_rgba(0,0,0,0.08)] hover:bg-[var(--input-bg)] hover:border-[var(--primary-color)]"
                href={href}
                target="_blank"
          ...
          {/* Divider */}
          <div className="flex items-center gap-2.5 my-3 text-[var(--text-gray)] [animation:fadeUp_0.5s_0.56s_both]">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-3 [animation:fadeUp_0.5s_0.60s_both]">
              <label className="block text-xs font-bold text-[var(--text-dark)] mb-[5px] tracking-[0.1px]">
                Correo electrónico
              </label>
              <input
                className="w-full py-[10px] px-3.5 bg-[var(--input-bg)] border-[1.5px] border-[var(--border-color)] rounded-[9px] text-[var(--text-dark)] font-[Manrope,sans-serif] text-[13.5px] font-medium outline-none transition-all box-border placeholder:text-[var(--text-gray)] placeholder:font-normal focus:border-[var(--primary-color)] focus:bg-[var(--surface-color)] focus:shadow-[0_0_0_3px_var(--focus-ring)]"
                type="email"
            ...
            <div className="mb-3 [animation:fadeUp_0.5s_0.66s_both]">
              ...
              <div className="relative">
                <input
                  className="w-full py-[10px] px-3.5 pr-[42px] bg-[var(--input-bg)] border-[1.5px] border-[var(--border-color)] rounded-[9px] text-[var(--text-dark)] font-[Manrope,sans-serif] text-[13.5px] font-medium outline-none transition-all box-border placeholder:text-[var(--text-gray)] placeholder:font-normal focus:border-[var(--primary-color)] focus:bg-[var(--surface-color)] focus:shadow-[0_0_0_3px_var(--focus-ring)]"
                ...
                <button
                  type="button"
                  className="absolute right-3 top-1/2 -translate-y-1/2 bg-transparent border-0 cursor-pointer p-0.5 flex items-center text-[var(--text-gray)] transition-colors hover:text-[var(--primary-color)]"
            ...
            <div className="flex items-center justify-between my-2.5 mb-4 [animation:fadeUp_0.5s_0.72s_both]">
              <label
                className="flex items-center gap-[7px] cursor-pointer text-[12.5px] font-medium text-[var(--text-dark)] select-none"
                onClick={() => setRemember(!remember)}
              >
                <span
                  className={`w-4 h-4 rounded-[4px] border-[1.5px] inline-block shrink-0 transition-all ${remember ? "bg-[var(--primary-color)] border-[var(--primary-color)]" : "border-[var(--border-color)] bg-[var(--surface-color)]"}`}
                  style={remember ? {
              ...
              <a href="#" className="text-[12.5px] font-semibold text-[var(--primary-color)] no-underline transition-opacity hover:opacity-70">
