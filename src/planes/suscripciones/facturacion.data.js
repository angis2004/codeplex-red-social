...
export const PRECIOS_FACTURACION = {
...
export const PAQUETES_COMPROBANTES = [
...
export const FEATURES_FACTURACION = {
...
export const PLANES_FACTURACION = [
  {
    key: "gratis",
    nombre: "Gratis",
    dark: false,
...
/* ── Chatbot ── */
export const CHATBOT_PREGUNTAS_FACTURACION = [
...
export const CHATBOT_RESPUESTAS_FACTURACION = {
  "¿Qué incluye el Plan Premium?":
...
export const CHATBOT_BIENVENIDA_FACTURACION = {
  tipo: "bot",
