...
export const FEATURES_GRIFO: Record<string, FeatureInfo> = {
  "Modulo de Grifo Completo": {
...
/* ── Chatbot ── */
export const CHATBOT_PREGUNTAS_GRIFO: string[] = [
...
export const CHATBOT_RESPUESTAS_GRIFO: Record<string, string> = {
  "¿Qué incluye el Plan Grifo?":
...
export const CHATBOT_BIENVENIDA_GRIFO: MensajeChatbot = {
  tipo: "bot",
