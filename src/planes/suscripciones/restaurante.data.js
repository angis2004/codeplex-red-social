...
export const FEATURES_COMUNES_RESTAURANTE = [
  "Configuraciones completas",
  "Ventas POS + SUNAT",
  "Ventas en Restaurante",
  "Tesorería",
...
export const FEATURES_GOLD_RESTAURANTE = [
  "Transferencia entre caja y Bancos",
  "Carga de constancias JPG/PDF/DOC",
  "Mayor Capacidad Operativa",
  "Soporte prioritario preferencial",
...
/* ── Chatbot ── */
export const CHATBOT_PREGUNTAS_RESTAURANTE = [
...
export const CHATBOT_RESPUESTAS_RESTAURANTE = {
  "¿Cuál plan si tengo 20 empresas?":
...
export const CHATBOT_BIENVENIDA_RESTAURANTE = {
  tipo: "bot",
