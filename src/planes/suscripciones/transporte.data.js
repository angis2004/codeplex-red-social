...
export const FEATURES_TRANSPORTE = {
  "Configuración completa": {
...
/* ── Chatbot ── */
export const CHATBOT_PREGUNTAS_TRANSPORTE = [
...
export const CHATBOT_RESPUESTAS_TRANSPORTE = {
  "¿Qué incluye el Plan Transporte?":
...
export const CHATBOT_BIENVENIDA_TRANSPORTE = {
  tipo: "bot",
