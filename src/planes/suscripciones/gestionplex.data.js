...
/* ── Chatbot ── */
export const CHATBOT_PREGUNTAS_COMERCIAL = [
...
export const CHATBOT_RESPUESTAS_COMERCIAL = {
  "¿Qué plan para 10 empresas?":
...
export const CHATBOT_BIENVENIDA_COMERCIAL = {
  tipo: "bot",
