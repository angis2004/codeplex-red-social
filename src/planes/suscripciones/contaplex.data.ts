...
export interface PlanContaPlex {
  id: string;
  nombre: string;
  precio: Precio;
  empresas: string;
...
export const PLANES_IND: PlanContaPlex[] = [
  {
    id: "gratis",
    nombre: "Gratis",
...
export const PLANES_EMP: PlanContaPlex[] = [
  {
    id: "basico",
    nombre: "Básico",
    precio: { mensual: "150", anual: "1,500" },
...
/* ── Chatbot ── */
export const CHATBOT_QUICK: string[] = [
...
export const CHATBOT_RESPUESTAS: Record<string, string> = {
  "¿Cuál plan si tengo 20 empresas?":
...
export const CHATBOT_MSG_INICIAL: MensajeChatbot = {
  tipo: "bot",
